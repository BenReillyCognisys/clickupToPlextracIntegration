...
//
// Permissions are enforced SERVER-SIDE per request, not carried in the token: the
// auth JWT holds only tenantCuid/username/userCuid/userId/license (confirmed with
// scripts/inspect-permissions.js). So re-authenticating or restarting the process
// cannot clear an authorization failure — there is no stale permission state on this
// side to flush, and a granted permission takes effect on the very next request.
//
